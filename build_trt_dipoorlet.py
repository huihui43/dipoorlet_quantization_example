# build trt engine using the quant model provided by dipoorlet
# 将dipoorlet生成的量化参数部署进trt engine里面
...
def main():
    onnx_file = "./dipoorlet_mse_brecq_200cls_exp2/quant_model.onnx" # dipoorlet生成的onnx file
    json_path = "./dipoorlet_mse_brecq_200cls_exp2/trt_clip_val.json" # dipoorlet生成的量化参数
    engine_file = "./trt/200cls/mobilev2_model_dipoorlet_mse_brecq.engine" # 我们想要生成的engile file
